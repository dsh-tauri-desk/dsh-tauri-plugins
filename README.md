...
| [`dsh-tauri-session`](./packages/dsh-tauri-session) | “归档”设置页与工作区浏览器的「归档工作区」替换 | `0.4.9` |
...
| [`dsh-tauri-rightclick`](./packages/dsh-tauri-rightclick) | 原生风格右键菜单：会话/工作区/正文/链接/输入框 | `0.4.9` |
