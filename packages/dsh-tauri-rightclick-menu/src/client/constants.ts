/** Shared protocol and UI constants for the dsh-tauri-rightclick-menu client plugin. */

export const RIGHTCLICK_CLIENT_PLUGIN = 'dsh-tauri-rightclick-menu'
...
/** css-render style id。 */
export const RIGHTCLICK_STYLE_ID = 'dsh-tauri-rightclick-menu-styles'
...
export const RIGHTCLICK_CLASSES = {
  menu: 'dsh-tauri-rightclick-menu',
  item: 'dsh-tauri-rightclick-menu-item',
  itemDanger: 'dsh-tauri-rightclick-menu-item--danger',
  shortcut: 'dsh-tauri-rightclick-menu-shortcut',
  separator: 'dsh-tauri-rightclick-menu-separator',
  toast: 'dsh-tauri-rightclick-menu-toast',
  dialogBackdrop: 'dsh-tauri-rightclick-menu-dialog-backdrop',
  dialog: 'dsh-tauri-rightclick-menu-dialog',
  dialogTitle: 'dsh-tauri-rightclick-menu-dialog-title',
  dialogMessage: 'dsh-tauri-rightclick-menu-dialog-message',
  dialogActions: 'dsh-tauri-rightclick-menu-dialog-actions',
  dialogButton: 'dsh-tauri-rightclick-menu-dialog-button',
  dialogConfirm: 'dsh-tauri-rightclick-menu-dialog-confirm',
} as const
