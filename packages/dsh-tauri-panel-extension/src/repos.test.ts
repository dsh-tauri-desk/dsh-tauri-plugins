...
describe('parseGitHubSource', () => {
  it('accepts the common URL shapes', () => {
    ...
    expect(parseGitHubSource('https://github.com/anthropics/skills/tree/feature%2Fdocs')?.githubUrl).toBe('https://github.com/anthropics/skills/tree/feature/docs')
    expect(parseGitHubSource('https://github.com/anthropics/skills')?.githubUrl).toBe('https://github.com/anthropics/skills')
...
describe('addLocalRepo', () => {
  it('registers a collection folder in place', async () => {
    ...
    expect(existsSync(join(home, 'dsh-tauri-panel-extension', 'state.json'))).toBe(true)
  })
...
describe('addGitRepo', () => {
  ...
  it('downloads, extracts, detects, and persists a collection repo', async () => {
    ...
    expect(entry.url).toBe('https://github.com/obra/superpowers')
    expect(entry.roots).toHaveLength(1)
